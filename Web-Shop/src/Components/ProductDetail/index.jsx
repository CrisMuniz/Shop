...
const ProductDetail = () => {
    ...
    return (
        <div className="flex flex-col fixed bg-white  rounded-lg w-[300px] h-[calc(100vh-130px)]  overflow-auto no-scrollbar shadow-lg hover:shadow-xl hover:scale-105 duration-500 transform transition">
